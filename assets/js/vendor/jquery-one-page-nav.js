!function(o, a, i) {
    ...
    n.defaults = (n.prototype = {
        ...
        init: function() {
            return this.config = o.extend({}, this.defaults, this.options, this.metadata),
        ...
        bindInterval: function() {
            ...
            n.t = setInterval(function() {
                t = n.$doc.height(),
                n.didScroll && (n.didScroll = !1,
                n.scrollChange()),
                t !== n.docHeight && (n.docHeight = t,
                n.getPositions())
            }, 250)
        },
        getHash: function(t) {
        ...
        getPositions: function() {
            ...
            i.$nav.each(function() {
                t = i.getHash(o(this)),
                (n = o("#" + t)).length && (n = n.offset().top,
                i.sections[t] = Math.round(n))
            })
        },
        getSection: function(t) {
            var n, i = null, s = Math.round(this.$win.height() * this.config.scrollThreshold);
            for (n in this.sections)
                this.sections[n] - s < t && (i = n);
            return i
        },
        handleClick: function(t) {
            var n = this
              ...
              , s = i.parent()
              , e = "#" + n.getHash(i);
            s.hasClass(n.config.currentClass) || (n.config.begin && n.config.begin(),
            n.adjustNav(n, s),
            n.unbindInterval(),
        ...
        scrollChange: function() {
            var t = this.$win.scrollTop()
              , t = this.getSection(t);
            null === t || (t = this.$elem.find('a[href$="#' + t + '"]').parent()).hasClass(this.config.currentClass) || (this.adjustNav(this, t),
