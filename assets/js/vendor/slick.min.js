!function(i) {
    ...
    r.prototype.setSlideClasses = function(i) {
        ...
        !0 === s.options.infinite && (o <= i && i <= s.slideCount - 1 - o ? s.$slides.slice(i - o + t, i + o + 1).addClass("slick-active").attr("aria-hidden", "false") : (e = s.options.slidesToShow + i,
    ...
    r.prototype.slideHandler = function(i, e, t) {
        var o, s, n, r = this;
        if (e = e || !1,
        !(!0 === r.animating && !0 === r.options.waitForAnimate || !0 === r.options.fade && r.currentSlide === i))
            if (!1 === e && r.asNavFor(i),
            o = i,
            e = r.getLeft(o),
            ...
            !1 === r.options.infinite && !1 === r.options.centerMode && (i < 0 || i > r.getDotCount() * r.options.slidesToScroll))
            ...
            else if (!1 === r.options.infinite && !0 === r.options.centerMode && (i < 0 || i > r.slideCount - r.options.slidesToScroll))
                !1 === r.options.fade && (o = r.currentSlide,
                !0 !== t ? r.animateSlide(n, function() {
                    r.postSlide(o)
                }) : r.postSlide(o));
                ...
                r.updateArrows(),
                !0 === r.options.fade)
                    return !0 !== t ? (r.fadeSlideOut(i),
                    r.fadeSlide(s, function() {
                        r.postSlide(s)
                    })) : r.postSlide(s),
                    void r.animateHeight();
                !0 !== t ? r.animateSlide(e, function() {
                    r.postSlide(s)
                }) : r.postSlide(s)
            }
    }
