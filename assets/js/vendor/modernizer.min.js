!function(s, f, c) {
    ...
    function i(e) {
        var t, n = T.className, o = _._config.classPrefix || "";
        E && (n = n.baseVal),
        _._config.enableJSClass && (t = new RegExp("(^|\\s)" + o + "no-js(\\s|$)"),
        n = n.replace(t, "$1" + o + "js$2")),
        _._config.enableClasses && (n += " " + o + e.join(" " + o),
        E ? T.className.baseVal = n : T.className = n)
    }
    function a(e, t) {
        if ("object" == typeof e)
            for (var n in e)
            ...
            1 == o.length ? _[o[0]] = t : (!_[o[0]] || _[o[0]]instanceof Boolean || (_[o[0]] = new Boolean(_[o[0]])),
            _[o[0]][o[1]] = t),
            i([(t && 0 != t ? "" : "no-") + o.join("-")]),
            _._trigger(e, t)
        }
    ...
    function r(e, t, n, o) {
        var r, s, i, a, l = "modernizr", u = p("div");
        (a = f.body) || ((a = p(E ? "svg" : "body")).fake = !0);
        if (parseInt(n, 10))
            for (; n--; )
                (s = p("div")).id = o ? o[n] : l + (n + 1),
                u.appendChild(s);
        return (r = p("style")).type = "text/css",
        r.id = "s" + l,
        (a.fake ? a : u).appendChild(r),
        a.appendChild(u),
        ...
        T.style.overflow = i,
        T.offsetHeight) : u.parentNode.removeChild(u),
        !!r
    }
    function l(e) {
    ...
    function R(e, t) {
        ...
        if ("CSSSupportsRule"in s) {
            ...
            return r("@supports (" + (o = o.join(" or ")) + ") { #modernizr { position: absolute; } }", function(e) {
                ...
                t = null,
                n = "position",
                "getComputedStyle"in s ? (o = getComputedStyle.call(s, e, t),
                r = s.console,
                null !== o ? n && (o = o.getPropertyValue(n)) : r && r[r.error ? "error" : "log"].call(r, "getComputedStyle returning null, its possible modernizr test results are inaccurate")) : o = !t && e.currentStyle && e.currentStyle[n],
                o);
                var t, n, o, r
            })
        }
    ...
    function o(e, t, n, o, r) {
        var s, i, a = e.charAt(0).toUpperCase() + e.slice(1), l = (e + " " + G.join(a + " ") + a).split(" ");
    ...
    }, _ = function() {}, M = (_.prototype = x,
    _ = new _,
    []), T = f.documentElement, E = "svg" === T.nodeName.toLowerCase(), W = "Moz O ms Webkit", P = x._config.usePrefixes ? W.toLowerCase().split(" ") : [], k = (x._domPrefixes = P,
    x._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""]), q = (x._prefixes = k,
    u = void 0 === (d = {}.hasOwnProperty) || void 0 === d.call ? function(e, t) {
    ...
    A = !("onblur"in f.documentElement),
    function(e, t) {
        var n;
        return !!e && (!(n = (e = "on" + e)in (t = t && "string" != typeof t ? t : p(t || "div"))) && A && ((t = t.setAttribute ? t : p("div")).setAttribute(e, ""),
    ...
    (t = s.matchMedia || s.msMatchMedia) ? function(e) {
        e = t(e);
    ...
    ,
    x._config.usePrefixes ? W.split(" ") : []), I = (x._cssomPrefixes = G,
    {
        elem: p("modernizr")
    ...
    ,
    x.testStyles = r,
    _.addTest("customelements", "customElements"in s),
    _.addTest("history", function() {
    ...
    _.addTest("postmessage", "postMessage"in s),
    ...
    for (w in _.addTest("flexbox", n("flexBasis", "1px", !0)),
    _.addTest("picture", "HTMLPictureElement"in s),
    _.addAsyncTest(function() {
        var e, t, n = p("img"), o = "sizes"in n;
        !o && "srcset"in n ? (e = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",
        n.onload = t = function() {
            a("sizes", 2 == n.width)
        }
        ,
    ...
    _.addTest("srcset", "srcset"in p("img")),
    _.addTest("webworkers", "Worker"in s),
    S)
        if (S.hasOwnProperty(w)) {
            if (e = [],
            (g = S[w]).name && (e.push(g.name.toLowerCase()),
            g.options && g.options.aliases && g.options.aliases.length))
                for (v = 0; v < g.options.aliases.length; v++)
                    e.push(g.options.aliases[v].toLowerCase());
            for (y = m(g.fn, "function") ? g.fn() : g.fn,
            C = 0; C < e.length; C++)
                1 === (b = e[C].split(".")).length ? _[b[0]] = y : (!_[b[0]] || _[b[0]]instanceof Boolean || (_[b[0]] = new Boolean(_[b[0]])),
                _[b[0]][b[1]] = y),
                M.push((y ? "" : "no-") + b.join("-"))
        }
    i(M),
